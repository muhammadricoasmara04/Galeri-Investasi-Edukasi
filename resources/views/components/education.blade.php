...
<div id={{ $id }} class="w-full bg-white border-gray-200 h-auto p-4">
    <div class="mx-auto max-w-4xl text-center">
        <h1 class="text-[32px] sm:text-[42px] text-black font-extrabold mt-10">Materi Edukasi</h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
        ...
        <div onclick="openModal('module1-modal')"
            ...
            <p class="text-gray-600 text-sm">Memahami pentingnya menabung dan cara memulai kebiasaan menabung</p>
        </div>
        ...
        <div onclick="openModal('module2-modal')"
            ...
            <p class="text-gray-600 text-sm">Cara bijak mengelola utang dan menghindari jebakan utang</p>
        </div>
        ...
        <div onclick="openModal('module3-modal')"
            ...
            <p class="text-gray-600 text-sm">Pengenalan instrumen investasi dan cara memulai investasi</p>
        </div>
        ...
        <div onclick="openModal('module4-modal')"
            ...
            <p class="text-gray-600 text-sm">Memahami pentingnya proteksi finansial dan jenis-jenis asuransi</p>
        </div>
    </div>

    <!-- Gambar Responsive -->
    <div class="w-full flex justify-center mt-10">
        <img class="w-full max-w-sm sm:max-w-md lg:max-w-[1024px] p-5 mx-auto rounded-lg object-cover"
            src="/img/education/education.png" alt="education" />
    </div>

    <!-- Footer Text -->
    <div class="mx-auto max-w-4xl text-center">
        <p class="text-[16px] sm:text-[20px] mt-2 text-[#4B5563]">
